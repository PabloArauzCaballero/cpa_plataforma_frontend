# v42 - Borradores respaldados por backend

## Objetivo

El frontend deja de tratar los borradores como un mecanismo únicamente local. Cuando el backend expone `administracion.registro_borrador`, los formularios guardan avances en base de datos y solo usan `localStorage` como respaldo de emergencia.
...
- Cargar borrador prioriza backend y luego respaldo local.
