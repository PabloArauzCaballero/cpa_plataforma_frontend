...
# Carpeta de las imagenes de producto que alimentan el grid del punto de venta.
ARG VITE_CLOUDINARY_PRODUCTOS_FOLDER=cpa/productos
...
ENV VITE_API_BASE_URL=$VITE_API_BASE_URL \
    ...
    VITE_CLOUDINARY_PRODUCTOS_FOLDER=$VITE_CLOUDINARY_PRODUCTOS_FOLDER
